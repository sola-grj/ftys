    ...
    <view class="container">
      <view class="login-container">
        ...
        <view class="show-time">
          ...
          >&nbsp;~
          <text v-if="activeIndex === '1'" class="end-time">{{ today }}</text>
          <text v-if="activeIndex === '2'" class="end-time">{{ sevenDay }}</text>
          <text v-if="activeIndex === '3'" class="end-time">{{ fifteenDay }}</text>
          <text v-if="activeIndex === '4'" class="end-time">{{ thirteenDay }}</text>
          &nbsp;
